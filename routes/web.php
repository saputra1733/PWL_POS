...
//    Route::post('/list', [UserController::class, 'list']);       // menampilkan halaman form tambah user
//    Route::get('/create', [UserController::class, 'create']);   // menyimpan data user baru
//    Route::post('/', [UserController::class, 'store']);          // menampilkan detail user
//    Route::get('/{id}', [UserController::class, 'show']);       // menampilkan halaman form edit user
//    Route::get('/{id}/edit', [UserController::class, 'edit']);  // menyimpan perubahan data user
